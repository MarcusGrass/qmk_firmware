...
[_DVORAK] = LAYOUT_ortho_4x12(
        ...
        KC_LCTL, KC_LGUI , KC_LALT, WILD  , LOWER, KC_SPC, KC_SPC, NUM ,  RAISE, KC_ALGR, SETTS, KC_RCTL  \
),
 ...
 * `-----------------------------------------------------------------------------------'
 */
[_DVORAK_ANSI] = LAYOUT_ortho_4x12(
        KC_TAB,  KC_QUOT,  KC_COMM,  KC_DOT,  KC_P,  KC_Y,   KC_F,  KC_G,  KC_C,    KC_R,    KC_L,    KC_BSPC,
        ESC_CTL, KC_A,     KC_O,     KC_E,    KC_U,  KC_I,   KC_D,  KC_H,  KC_T,    KC_N,    KC_S,    KC_ENT,
        KC_LSFT, KC_SCLN,  KC_Q,     KC_J,    KC_K,  KC_X,   KC_B,  KC_M,  KC_W,    KC_V,    KC_Z,    KC_LSFT,
        KC_LCTL, KC_LGUI,  KC_LALT,  WILD,    LOWANS,KC_SPC, KC_SPC,NUM,   RAISE,   KC_ALGR, SETTS,   KC_RCTL
),
 ...
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY_ANSI] = LAYOUT_ortho_4x12(
